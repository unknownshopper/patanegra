                      ...
                      <div key={t.id} className="tabRow">
                        ...
                        {expandedTabId === t.id ? (
                          <div style={{ gridColumn: '1 / -1', marginTop: 10 }}>
                            ...
                            <details style={{ border: '1px solid rgba(0,0,0,0.08)', borderRadius: 12, padding: 10 }}>
                              <summary style={{ cursor: 'pointer', fontWeight: 900 }}>Quitar productos (cuenta abierta)</summary>
                              <div style={{ height: 10 }} />
                              <div className="card" style={{ margin: 0, padding: 10 }}>
                                {(() => {
